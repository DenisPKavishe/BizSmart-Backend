...
from .views import (
    ...
    InvoiceListCreateView, InvoiceDetailView, RecordPaymentView,
    LoanListCreateView, LoanDetailView, LoanPaymentView,
    PettyCashListCreateView, PettyCashDetailView,
    CashFlowForecastView,
    CompleteFinancialDashboardView,
    ExportFinancialReportView,
    BudgetListCreateView, BudgetDetailView,
    BudgetItemListCreateView, BudgetItemDetailView,
    BudgetVsActualView, CopyBudgetView, BudgetSummaryView
)
...
urlpatterns = [
    ...
    path('loans/<int:pk>/pay/', LoanPaymentView.as_view(), name='loan-payment'),
